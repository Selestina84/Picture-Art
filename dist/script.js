...
/* harmony import */ var _modules_dragEndDrop__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/dragEndDrop */ "./src/js/modules/dragEndDrop.js");
/* harmony import */ var _modules_changeImage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/changeImage */ "./src/js/modules/changeImage.js");
...
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/burger */ "./src/js/modules/burger.js");
...
/* harmony import */ var _modules_calcForm__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/calcForm */ "./src/js/modules/calcForm.js");
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/mask */ "./src/js/modules/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_dragEndDrop__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_changeImage__WEBPACK_IMPORTED_MODULE_5__["default"])('.sizes-block');
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_7__["default"])('.burger-menu', '.burger');
  ...
  Object(_modules_calcForm__WEBPACK_IMPORTED_MODULE_11__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_12__["default"])('[name = "phone"]');
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSelector, trigger) {
  var menuElem = document.querySelector(menuSelector),
      burgerBtn = document.querySelector(trigger);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _servises_requests__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../servises/requests */ "./src/js/servises/requests.js");


var calcForm = function calcForm(sizeSelector, materialSelector, optionSelector, promoSelector, calcFieldSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (calcForm);
...
var changeImage = function changeImage(blockSelector) {
  var blocks = document.querySelectorAll(blockSelector);

  function showImage(item) {
    var img = item.querySelector('img');
    img.src = img.src.slice(0, -4) + '-1.png';
    item.querySelectorAll('p:not(.sizes-hit)').forEach(function (elem) {
  ...
  function hideImage(item) {
    ...
    item.querySelectorAll('p').forEach(function (elem) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeImage);
...
var checkTextInputs = function checkTextInputs(selector) {
  ...
  textInputs.forEach(function (input) {
    input.addEventListener('input', function () {
      input.value = input.value.replace(/[a-z]/ig, ''); //  console.log(input.value)
    });
  });
};
...
var dragEndDrop = function dragEndDrop() {
...
/* harmony default export */ __webpack_exports__["default"] = (dragEndDrop);
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (_ref) {
    ...
    if (target && target.tagName == "LI") {
      menu.querySelectorAll('li').forEach(function (btn) {
  ...
  function filter(markSelector) {
    document.querySelectorAll('.portfolio-wrapper .all').forEach(function (item) {
      item.style.display = 'none';
    ...
    if (markSelector) {
      var markType = document.querySelectorAll(markSelector);
...
/* harmony import */ var _servises_requests__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../servises/requests */ "./src/js/servises/requests.js");
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var obj = {};
      var select = document.querySelector('#size');
      ...
      if (item.classList.contains('calc_form')) {
        ...
        _formData.append("id", Math.random());

        _formData.forEach(function (key, value) {
          obj[key] = value;
        });
      } //console.log(obj)
      ...
      Object(_servises_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, obj).then(function (res) {
        console.log(res);
...
/* harmony import */ var _closeModals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./closeModals */ "./src/js/modules/closeModals.js");
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); //убираем кнопку наверх

        btnUp.style.display = "none";
      });
    });
    closeBtn.addEventListener('click', function () {
      Object(_closeModals__WEBPACK_IMPORTED_MODULE_2__["default"])(modalSelector);
      document.body.style.marginRight = "0px"; //Добавляем кнопку наверх обратно
...
var scrolling = function scrolling(upSelector) {
  window.addEventListener('scroll', function () {
    var upBlock = document.querySelector(upSelector);

    if (document.documentElement.scrollTop > 1650) {
      upBlock.classList.add('animated', 'fadeIn');
      upBlock.classList.remove('fadeOut');
    } else {
      upBlock.classList.add('fadeOut');
      upBlock.classList.remove('fadeIn');
    }
  });
...
var showMoreStyles = function showMoreStyles(trigger, items) {
...
var sliders = function sliders(_sliders, direction, prev, next) {
  var slides = document.querySelectorAll(_sliders);
  var slideIndex = 1,
      paused;
